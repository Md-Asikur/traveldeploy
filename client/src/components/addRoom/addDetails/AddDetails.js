...
const AddDetails = () => {
  const {
    state: {
      details: { title, description, price, roll,  studentName },
    },
    dispatch,
  } = useValue();
  ...
  return (
    ...
    >
      ...
      <InfoField mainProps={{ name: "studentName", label: "Name", value: studentName }} />
      <InfoField mainProps={{ name: "roll", label: "Roll", value: roll }} minLength={5} />
      <InfoField mainProps={{ name: "price", label: "Price", value: price }} />
      <InfoField
